...
/* harmony import */ var _modules_toggle_content__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/toggle-content */ "./js/modules/toggle-content.js");
...
/* harmony import */ var _modules_mask__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./modules/mask */ "./js/modules/mask.js");
/* harmony import */ var _modules_validation__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./modules/validation */ "./js/modules/validation.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_toggle_content__WEBPACK_IMPORTED_MODULE_5__["toggleContent"])();
  ...
  window.addEventListener('load', function () {
    ...
    Object(_modules_mask__WEBPACK_IMPORTED_MODULE_7__["initPhoneMask"])();
    Object(_modules_validation__WEBPACK_IMPORTED_MODULE_8__["validateForm"])();
    initPhoneInput();
  });
});
...
function initAccordion() {
  ...
  var accTouch = document.querySelectorAll('.accordion__wrapper');
  var listLinks = document.querySelectorAll('.accordion__link');
  accTouch.forEach(function (item) {
  ...
  function setTabindex() {
    listLinks.forEach(function (itemLink) {
      return itemLink.setAttribute('tabindex', '-1');
    });
  }
  function removeTabindex() {
    listLinks.forEach(function (itemLink) {
      return itemLink.removeAttribute('tabindex');
    });
  }
  if (screen.width < 768) {
    setTabindex();
...
function initPhoneMask() {
  var phoneInputs = document.querySelectorAll('[data-validate-type="phone"]');
...
var introButton = document.querySelector('.intro__link-btn');
...
var hiddenText = document.querySelector('.about-company__box');
var toggleButton = document.querySelector('.about-company__btn');
var toggleTextMob = document.querySelector('.about-company__text-mob');
