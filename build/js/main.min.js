...
/* harmony import */ var _modules_toggle_content__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/toggle-content */ "./js/modules/toggle-content.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_toggle_content__WEBPACK_IMPORTED_MODULE_4__["toggleContent"])();
...
function initAccordion() {
  ...
  var listLinks = document.querySelectorAll('.accordion a');
  if (accTouch && accBtns) {
...
var username = document.querySelector('.modal input[name=username]');
var phone = document.querySelector('.modal input[name=phone]');
var modalForm = document.querySelector('#modal-form');
var checkbox = document.querySelector('#modal-agreement');
